...
#define STRING_CONFIG_H_AUTHOR "(jnss, Ender-3 Pro)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "BLT Level " STRINGIFY(GRID_MAX_POINTS_X) "x" STRINGIFY(GRID_MAX_POINTS_Y)
